...
public class FrmCongelado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Temp Congelacion:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double tempCongelada = Double.parseDouble(jTextField4.getText());
        
        Congelado prod = new Congelado (nombre, FCaducidad, NLote, tempCongelada);
        
        jTextArea2.setText(prod.mostrarInformacion());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCongelado().setVisible(true);
            }
        });
    }
